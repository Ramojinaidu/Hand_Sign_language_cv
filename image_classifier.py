...
class Classifier:
    """
    Classifier class that handles image classification using a pre-trained Keras models.
    """

    def __init__(self, modelPath, labelsPath=None):
        """
        Initializes the Classifier with the models and labels.

        :param modelPath: str, path to the Keras models
        ...
        # Create a NumPy array with the right shape to feed into the Keras models
